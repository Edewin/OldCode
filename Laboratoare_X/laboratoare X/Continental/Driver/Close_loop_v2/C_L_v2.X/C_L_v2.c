...
#define POTMULT 8				// pot to speed ratio

#define Kps	110					// Kp and Ks terms need to be adjusted as per
#define Kis	0.00022					// the motor and load
