 ...
 * Author: Eduard
 *
 * Created on January 21, 2014, 10:19 PM
 */
...
#define Kps	5					// Kp and Ks terms need to be adjusted as per 750 and 20
#define Kis	1					// the motor and load
...
/**********************************************************************
 Initialize the INT pins *** INT1 and INT2 ***
 **********************************************************************/
void init_INT(void)
{
   // TRISDbits.TRISD0=1;
