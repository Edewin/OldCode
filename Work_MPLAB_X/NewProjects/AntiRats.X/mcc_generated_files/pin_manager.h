...
#define LED_LAT                LATA1
#define LED_PORT               RA1
#define LED_WPU                WPUA1
#define LED_ANS                ANSA1
#define LED_SetHigh()    do { LATA1 = 1; } while(0)
#define LED_SetLow()   do { LATA1 = 0; } while(0)
#define LED_Toggle()   do { LATA1 = ~LATA1; } while(0)
#define LED_GetValue()         RA1
#define LED_SetDigitalInput()    do { TRISA1 = 1; } while(0)
#define LED_SetDigitalOutput()   do { TRISA1 = 0; } while(0)

#define LED_SetPullup()    do { WPUA1 = 1; } while(0)
#define LED_ResetPullup()   do { WPUA1 = 0; } while(0)
#define LED_SetAnalogMode()   do { ANSA1 = 1; } while(0)
#define LED_SetDigitalMode()   do { ANSA1 = 0; } while(0)
...
#define RC0_SetPullup()    do { WPUC0 = 1; } while(0)
#define RC0_ResetPullup()   do { WPUC0 = 0; } while(0)
...
#define RC1_GetValue()         RC1
#define RC1_SetDigitalInput()    do { TRISC1 = 1; } while(0)
#define RC1_SetDigitalOutput()   do { TRISC1 = 0; } while(0)
#define RC1_SetPullup()    do { WPUC1 = 1; } while(0)
#define RC1_ResetPullup()   do { WPUC1 = 0; } while(0)
#define RC1_SetAnalogMode()   do { ANSC1 = 1; } while(0)
#define RC1_SetDigitalMode()   do { ANSC1 = 0; } while(0)
...
#define RC4_SetAnalogMode()   do { ANSC4 = 1; } while(0)
#define RC4_SetDigitalMode()   do { ANSC4 = 0; } while(0)
...
#define RC5_SetAnalogMode()   do { ANSC5 = 1; } while(0)
#define RC5_SetDigitalMode()   do { ANSC5 = 0; } while(0)
